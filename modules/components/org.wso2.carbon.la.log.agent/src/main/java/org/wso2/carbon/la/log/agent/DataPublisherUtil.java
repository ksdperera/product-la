...
public class DataPublisherUtil {
    ...
    public static void setTrustStoreParams() {
        File filePath = new File("modules" + File.separator + "components" + File.separator + "org.wso2.carbon.la.log.agent" + File.separator + "src" + File.separator + "main" + File.separator + "resources");
